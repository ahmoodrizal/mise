...
class Rajaongkir {
  final Query? query;
  final Status? status;
  final Detail? originDetails;
  final Detail? destinationDetails;
  ...
  factory Rajaongkir.fromMap(Map<String, dynamic> json) => Rajaongkir(
        ...
        originDetails: json["origin_details"] == null ? null : Detail.fromMap(json["origin_details"]),
        destinationDetails: json["destination_details"] == null ? null : Detail.fromMap(json["destination_details"]),
