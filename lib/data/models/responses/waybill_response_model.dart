...
class WaybillResponseModel {
  ...
  factory WaybillResponseModel.fromJson(String str) => WaybillResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory WaybillResponseModel.fromMap(Map<String, dynamic> json) => WaybillResponseModel(
