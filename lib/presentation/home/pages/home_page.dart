...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    context.read<BestSellerProductBloc>().add(const BestSellerProductEvent.getBestSellerProducts());
    context.read<NewArrivalBloc>().add(const NewArrivalEvent.getNewArrivalProducts());
    super.initState();
  }
            ...
            builder: (context, state) {
              return state.maybeWhen(
                loaded: (products, _, __, ___, ____, _____) {
                  final totalQuantity = products.fold(0, (previousValue, element) => previousValue + element.quantity);
