...
import 'package:mise/presentation/order/models/bank_account_model.dart';
...
class _PaymentWaitingPageState extends State<PaymentWaitingPage> {
  ...
  void initState() {
    _timer = Timer.periodic(
      ...
      (Timer timer) {
        context.read<CheckStatusBloc>().add(CheckStatusEvent.checkOrderStatus(widget.orderId));
      },
    );
    super.initState();
  }
                ...
                return state.maybeWhen(
                  ...
                  loaded: (orderResponseModel) {
                    return Row(
                      ...
                      children: [
                        Text(
                          banks.where((element) => element.code == orderResponseModel.order!.paymentVaName!).first.name,
                        ...
                        Image.asset(
                          banks.where((element) => element.code == orderResponseModel.order!.paymentVaName!).first.image,
                          height: 18.0,
                        ),
                      ],
                    );
            ...
            Row(
              ...
              children: [
                ...
                Button.outlined(
                  ...
                  width: 125.0,
                  onPressed: () {
                    Clipboard.setData(const ClipboardData(text: 'test dong')).then((_) {
